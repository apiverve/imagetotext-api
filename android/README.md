...
```java
import com.apiverve.imagetotext.ImagetoTextAPIClient;
import com.apiverve.imagetotext.APIResponse;
import com.apiverve.imagetotext.APIException;

// Initialize the client
ImagetoTextAPIClient client = new ImagetoTextAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/imagetotext](https://docs.apiverve.com/ref/imagetotext)
...
- **Documentation:** [https://docs.apiverve.com/ref/imagetotext](https://docs.apiverve.com/ref/imagetotext)
- **Issues:** [GitHub Issues](https://github.com/apiverve/imagetotext-api/issues)
