...
namespace APIVerve\Imagetotext;
...
/**
 * Client for the Image to Text API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://imagetotext.apiverve.com?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/imagetotext';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\ImagetotextClient] {$message}\n";
        }
    }
}
