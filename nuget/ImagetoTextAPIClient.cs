...
namespace APIVerve.API.ImagetoText
{
    ...
    /// <summary>
    /// Client for the ImagetoText API
    /// </summary>
    public class ImagetoTextAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/imagetotext";
        ...
        public ImagetoTextAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public ImagetoTextAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public ImagetoTextAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, ImagetoTextQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(ImagetoTextQueryOptions options)
        {
        ...
        public ResponseObj Execute(ImagetoTextQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(ImagetoTextQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(ImagetoTextQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(ImagetoTextQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(ImagetoTextQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(ImagetoTextQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(ImagetoTextQueryOptions options)
        {
